  ...
  factory: (require) => {
    ...
    const dictionaries = {
      zh: {
        ...
        'plugins.readonlyDescription': 'Harness 0.1.5-rc.2 只提供插件状态查询，没有安全的启用、停用或卸载接口。这里不会显示无效按钮；后续受管安装能力会在具备事务和恢复机制后开放。',
      ...
      en: {
        ...
        'plugins.readonlyDescription': 'Harness 0.1.5-rc.2 exposes plugin status but no safe enable, disable, or uninstall API. Invalid controls are not shown; managed installation will remain closed until transactions and recovery are available.',
