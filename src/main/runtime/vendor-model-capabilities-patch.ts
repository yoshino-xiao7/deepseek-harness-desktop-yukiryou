/**
 * Temporary downstream patch for DeepSeek Harness 0.1.0-rc.7.
 *
 * The pi-ai adapter already accepts `models[].input`, but the curated Models
 * settings editor does not expose it. Keep this transformation exact and
 * version-scoped so an upstream bundle change cannot be patched accidentally.
 */
export const MODEL_CAPABILITIES_PATCH_DSH_VERSION = '0.1.0-rc.7';
